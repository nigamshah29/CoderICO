...
contract PreCoderCoin is IERC20 {
    
    using SafeMath for uint256;
  
    string public symbol = 'PCDR';

    string public name = 'PreCoderCoin';
    
    uint8 public constant decimals = 18;
    
    uint256 public constant tokensPerEther = 1000;

    uint256 public EtherPerDollar; //Need to change this to store a decimal value for # of ETH per USD
    ...
    function () payable {
        ...
        uint256 bonusTokens = baseTokens.mul(bonusPercentage).div(1000);
        ...
        _totalSupply      = _totalSupply.sub(baseTokens).sub(bonusTokens);
